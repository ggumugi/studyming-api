...
module.exports = class User extends Sequelize.Model {
   ...
   static associate(db) {
      ...
      User.hasMany(db.Noti, { foreignKey: 'recieveId', sourceKey: 'id', as: 'ReceivedNotifications', onDelete: 'CASCADE' })
      User.hasMany(db.Noti, { foreignKey: 'sendId', sourceKey: 'id', as: 'SentNotifications', onDelete: 'CASCADE' })
